...
class GunClient:
    def _init(self, wsendpoint="ws://localhost:8000/gun"):
        self.wsendpoint = wsendpoint
        self.ws = None
        self.backend = DummyKV()  # TODO: what is this, why needed

    def put(self, soul, **kwargs):
        with websockets.connect(self.wsendpoint) as ws:
