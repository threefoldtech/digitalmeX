...
server = j.servers.gedis.configure(
    host="localhost", port="8000", websockets_port="8001", ssl=False, secret="", app_dir="", instance="orderbook"
)
server.start()
...
b1 = cl.order_book.add_buy_order(
    price_max="10 ETH",
    currency_to_buy="BTC",
    currency_mine=["USD"],
    amount=100,
    expiration=j.data.time.epoch + 1000,
    approved=True,
)
print("[-] adding buy order2")
b2 = cl.order_book.add_buy_order(
    price_max="10 ETH",
    currency_to_buy="BTC",
    currency_mine=["USD"],
    amount=100,
...
b3 = cl.order_book.add_buy_order(
    price_max="10 ETH",
    currency_to_buy="BTC",
    currency_mine=["USD"],
    amount=100,
...
s1 = cl.order_book.add_sell_order(
    price_min="10 XRP",
    currency_to_sell="BTC",
    currency_accept=["USD"],
    amount=100,
    expiration=j.data.time.epoch + 1000,
    approved=True,
...
s2 = cl.order_book.add_sell_order(
    price_min="10 XRP",
    currency_to_sell="BTC",
    currency_accept=["USD"],
    amount=100,
...
s3 = cl.order_book.add_sell_order(
    price_min="10 XRP",
    currency_to_sell="BTC",
    currency_accept=["USD"],
    amount=100,
