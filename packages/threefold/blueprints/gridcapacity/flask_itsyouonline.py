...
def configure(blueprint, organization, client_secret, callback_uri, callback_route, scope=None, get_jwt=False, offline_access=False, orgfromrequest=False):
    """
    ...
    """
    blueprint.before_request(_invalidate_session)
    blueprint.config = {}
    blueprint.config['iyo_config'] = dict(organization=organization, client_secret=client_secret,
