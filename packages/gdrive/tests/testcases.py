...
png_urls = list()
pdf_urls = list()
[png_urls.append(i) for i in png_links if i not in ['\n', '']]
[pdf_urls.append(i) for i in pdf_links if i not in ['\n', '']]
...
class Testcases(Basetest):
    ...
    def test002_pdf_urls(self, url):
        ...
        **Test Scenario:**
        ...
        self.log('Check the content type is pdf')
        content_type = req.headers['content-Type']
