...
class open_publish(JSBASE):
    ...
    def publish_wiki(self, name, repo_url, domain):
        """
        ```in
        name = ""
        repo_url = ""
        ...
        :return:
        """
        self.open_publish_client.add_wiki(name, repo_url, domain)
        return True

    def publish_website(self, name, repo_url, domain):
        """
        ```in
        name = ""
        repo_url = ""
        ...
        :return:
        """
        self.open_publish_client.add_website(name, repo_url, domain)
        return True
